                        ...
                        return [
                            ...
                            function (t, e) {
                                ...
                                for (
                                    ...
                                    "" === O(d[0]) &&
                                        (n.lastIndex = S(i, T(n.lastIndex), o));
                                for (
                                    var c, l = "", u = 0, h = 0;
                                    h < a.length;
                                    h++
                ...
                var i = n(4),
                    ...
                    _ =
                        ...
                        !o(function () {
                            return (
                                8 !==
                                f(function () {}, "length", { value: 8 }).length
                            );
                        }),
                    ...
                    ("__proto__" in {}
                        ? (function () {
                              var n,
                                  ...
                                  t = {};
                              try {
                                  (n = o(Object.prototype, "__proto__", "set"))(
                                      t,
                                      []
                                  ),
            ...
            function (M, t, e) {
                ...
                function vt(n, i) {
                    if (
                        ...
                        const o = (t) => {
                            t = t.target;
                            t === i &&
                                ((e = !0), i.removeEventListener(st, o), d(n));
                        };
                ...
                const Pt = {
                    ...
                    trigger(t, e, n) {
                        ...
                        i = Nt(
                            (i = new Event(e, { bubbles: r, cancelable: !0 })),
                            n
                        );
                        return (
                            a && i.preventDefault(),
                ...
                class b extends _ {
                    constructor(t) {
                        super(t),
                            (this._fn = {}),
                            this._element &&
                                (r.setData(this._element, Vt, this),
                                this._init());
                    }
                    static get NAME() {
                        return Qt;
                ...
                var be = class extends g {
                    ...
                    deactivate() {
                        this._isActive &&
                            ((this._isActive = !1), f.off(document, de));
                    }
                    _handleFocusin(t) {
                ...
                f.on(
                    ...
                    f.on(window, w, () => {
                        for (const t of y.find(we))
                            Ie.getOrCreateInstance(t).show();
                    }),
                    f.on(window, E, () => {
                ...
                class We extends _ {
                    ...
                    dispose() {
                        s.off(this._element, Me),
                            s.off(this._element, He),
                            super.dispose();
                    }
                    static get NAME() {
                        return Ne;
                ...
                (E = "load".concat(v).concat(w)),
                    (_ = "click".concat(v).concat(w));
                const ln = "carousel",
                    un = "active",
                    hn = ".active",
                    dn = ".carousel-item";
                ...
                class mn extends m {
                    ...
                    pause() {
                        this._isSliding && lt(this._element),
                            this._clearInterval();
                    }
                    cycle() {
                        this._clearInterval(),
                    ...
                    _addTouchEventListeners() {
                        ...
                        this._swipeHelper = new Ge(this._element, {
                            ...
                            rightCallback: () =>
                                this._slide(this._directionToOrder(en)),
                            endCallback: () => {
                                "hover" === this._config.pause &&
                                    (this.pause(),
                                    this.touchTimeout &&
                    ...
                    _slide(e) {
                        ...
                        if (!this._isSliding) {
                            ...
                            const o =
                                t ||
                                bt(this._getItems(), i, n, this._config.wrap);
                            if (o !== i) {
                ...
                function Gi(t, e) {
                    ...
                    var n = (function t(e) {
                        ...
                        i = A(n),
                        i = t
                            ? [i].concat(i.visualViewport || [], $i(n) ? n : [])
                            : n,
                        n = e.concat(i);
                ...
                function Ji(t, e, n) {
                    return e === ni
                        ...
                        : Zi(
                              ...
                              "rtl" === D(l || c).direction &&
                                  (s +=
                                      yi(c.clientWidth, l ? l.clientWidth : 0) -
                                      i),
                ...
                function no(t, e) {
                    var i,
                        ...
                        c = to(
                            _i(c)
                                ? c
                                : c.contextElement || Si(t.elements.popper),
                            r,
                            s,
                            o
                        ),
                        ...
                        w &&
                            (d &&
                                ...
                                (o = m
                                    ...
                                    : _ + l + i + h.mainAxis),
                                (m = (n =
                                    u.elements.arrow && ki(u.elements.arrow))
                                    ? "y" === b
                                        ? n.clientTop || 0
                                        : n.clientLeft || 0
                                    : 0),
                ...
                var mo = go(),
                    _o = go({
                        defaultModifiers: [zi, co, Fi, bi, ao, io, lo, Hi, so],
                    }),
                ...
                class ar extends m {
                    ...
                    _maybeEnableSmoothScroll() {
                        this._config.smoothScroll &&
                            ...
                            f.on(this._config.target, er, ir, (t) => {
                                var e = this._observableSections.get(
                                    t.target.hash
                                );
                                e &&
                                    (t.preventDefault(),
                    ...
                    _observerCallback(t) {
                        const e = (t) =>
                            this._targetLinks.get("#".concat(t.target.id));
                        var n = (t) => {
                    ...
                    _initializeTargetsAndObservables() {
                        ...
                        for (const e of y.find(ir, this._config.target))
                            e.hash &&
                                !dt(e) &&
                                ((t = y.findOne(e.hash, this._element)),
                                ht(t)) &&
                    ...
                    _activateParents(t) {
                        if (t.classList.contains("dropdown-item"))
                            ...
                            for (const e of y.parents(t, ".nav, .list-group"))
                                for (const n of y.prev(e, or))
                                    n.classList.add(nr);
                    }
                    _clearActiveClass(t) {
                        t.classList.remove(nr);
                        for (const e of y.find(
                            "".concat(ir, ".").concat(nr),
                            t
                        ))
                    ...
                    show() {
                        ...
                        this._elemIsActive(n) ||
                            ((e = (t = this._getActiveElem())
                                ...
                                : null),
                            f.trigger(n, vr, { relatedTarget: t })
                                .defaultPrevented) ||
                ...
                class Nr extends v {
                    dispose() {
                        s.off(this._element, Lr),
                            s.off(this._element, Ir),
                            super.dispose();
                    }
                    static get NAME() {
                        return Sr;
                ...
                class cs extends m {
                    ...
                    _setListeners() {
                        f.on(this._element, $r, (t) =>
                            this._onInteraction(t, !0)
                        ),
                            f.on(this._element, Gr, (t) =>
                                this._onInteraction(t, !1)
                            ),
                            f.on(this._element, Zr, (t) =>
                                this._onInteraction(t, !0)
                            ),
                            f.on(this._element, Jr, (t) =>
                                this._onInteraction(t, !1)
                            );
                    }
                    _clearTimeout() {
                ...
                const ca = "show",
                    la =
                        '[data-mdb-toggle="dropdown"]:not(.disabled):not(:disabled)',
                        ...
                        if (
                            ...
                            for (const o of y.find(ua)) {
                                ...
                                i &&
                                    ...
                                    ((e = (n = t.composedPath()).includes(
                                        i._menu
                                    )),
                                    n.includes(i._element) ||
                                        ("inside" === i._config.autoClose &&
                                            !e) ||
                                        ("outside" === i._config.autoClose &&
                                            e) ||
                    ...
                    _autoInit(e) {
                        ...
                        this._element.style.minWidth ||
                            (c.style(this._element, {
                                "min-width": "".concat(
                                    getComputedStyle(this._element).width
                                ),
                            }),
                            ...
                            (this._rippleTimer = setTimeout(() => {
                                e &&
                                    ...
                                    this._isMinWidthSet &&
                                        ...
                                        (this._isMinWidthSet = !1)),
                                    this._rippleInSpan &&
                                    this._element.classList.contains(Ba)
